...
```{r}
# Setting up the data
# Adding in the distinct code to focus on just trees
###### rodne_pid AA ############################################
...
ggplot(combined_rogue_stem_data, aes(y = dbh, fill = factor(year))) +
  geom_boxplot() +
  scale_y_continuous(name = "Diameter (cm)") +
...
```{r}
# AA
aaplot <- ggplot(combined_data_aa, aes(x = x, y = y, color = spcd, size = cut(dbh, breaks = c(24.5, 43, 66, 81, 178)))) +
  geom_point() +
...
# AB
abplot <- ggplot(combined_data_ab, aes(x = x, y = y, color = spcd, size = cut(dbh, breaks = c(24.5, 43, 66, 81, 178)))) +
  geom_point() +
  scale_color_manual(values = color_palette) +
...
# AC
acplot <- ggplot(combined_data_ac, aes(x = x, y = y, color = spcd, size = cut(dbh, breaks = c(24.5, 43, 66, 81, 178)))) +
  geom_point() +
  scale_color_manual(values = color_palette) +
...
# AD
adplot <- ggplot(combined_data_ad, aes(x = x, y = y, color = spcd, size = cut(dbh, breaks = c(24.5, 43, 66, 81, 178)))) +
  geom_point() +
  scale_color_manual(values = color_palette) +
...
# BA
baplot <- ggplot(combined_data_ba, aes(x = x, y = y, color = spcd, size = cut(dbh, breaks = c(24.5, 43, 66, 81, 178)))) +
  geom_point() +
  scale_color_manual(values = color_palette) +
...
# CA
caplot <- ggplot(combined_data_ca, aes(x = x, y = y, color = spcd, size = cut(dbh, breaks = c(24.5, 43, 66, 81, 178)))) +
  geom_point() +
  scale_color_manual(values = color_palette) +
...
# MA
maplot <- ggplot(combined_data_ma, aes(x = x, y = y, color = spcd, size = cut(dbh, breaks = c(24.5, 43, 66, 81, 178)))) +
  geom_point() +
  scale_color_manual(values = color_palette) +
...
# VA
vaplot <- ggplot(combined_data_va, aes(x = x, y = y, color = spcd, size = cut(dbh, breaks = c(24.5, 43, 66, 81, 178)))) +
  geom_point() +
  scale_color_manual(values = color_palette) +
...
```{r}
ggplot(combined_data_aa, aes(x = x, y = y, color = spcd, size = cut(dbh, breaks = c(24.5, 43, 66, 81, 178)))) +
  geom_point() +
  scale_color_manual(values = color_palette) +
  labs(title = "AA Stem Map", color = "Species", size = "Diameter (cm)") +
...
```{r}
ggplot(combined_data_ab, aes(x = x, y = y, color = spcd, size = cut(dbh, breaks = c(24.5, 43, 66, 81, 178)))) +
  geom_point() +
  scale_color_manual(values = color_palette) +
  labs(title = "AB Stem Map", color = "Species", size = "Diameter (cm)") +
  guides(color = guide_legend(override.aes = list(size = 4))) +  
  facet_wrap(~year) +
  theme_minimal() +
  theme(
...
```{r}
ggplot(combined_data_ac, aes(x = x, y = y, color = spcd, size = cut(dbh, breaks = c(24.5, 43, 66, 81, 178)))) +
  geom_point() +
  scale_color_manual(values = color_palette) +
  labs(title = "AC Stem Map", color = "Species", size = "Diameter (cm)") +
  guides(color = guide_legend(override.aes = list(size = 4))) +  
  facet_wrap(~year) +
  theme_minimal() +
  theme(
...
```{r}
ggplot(combined_data_ad, aes(x = x, y = y, color = spcd, size = cut(dbh, breaks = c(24.5, 43, 66, 81, 178)))) +
  geom_point() +
  scale_color_manual(values = color_palette) +
  labs(title = "AD Stem Map", color = "Species", size = "Diameter (cm)") +
  guides(color = guide_legend(override.aes = list(size = 4))) +  
  facet_wrap(~year) +
  theme_minimal() +
  theme(
...
```{r}
ggplot(combined_data_ba, aes(x = x, y = y, color = spcd, size = cut(dbh, breaks = c(24.5, 43, 66, 81, 178)))) +
  geom_point() +
  scale_color_manual(values = color_palette) +
  labs(title = "BA Stem Map", color = "Species", size = "Diameter (cm)") +
  guides(color = guide_legend(override.aes = list(size = 4))) +  
  facet_wrap(~year) +
  theme_minimal() +
  theme(
...
```{r}
ggplot(combined_data_ca, aes(x = x, y = y, color = spcd, size = cut(dbh, breaks = c(24.5, 43, 66, 81, 178)))) +
  geom_point() +
  scale_color_manual(values = color_palette) +
  labs(title = "CA Stem Map", color = "Species", size = "Diameter (cm)") +
  guides(color = guide_legend(override.aes = list(size = 4))) +  
  facet_wrap(~year) +
  theme_minimal() +
  theme(
...
```{r}
ggplot(combined_data_ma, aes(x = x, y = y, color = spcd, size = cut(dbh, breaks = c(24.5, 43, 66, 81, 178)))) +
  geom_point() +
  scale_color_manual(values = color_palette) +
  labs(title = "MA Stem Map", color = "Species", size = "Diameter (cm)") +
  guides(color = guide_legend(override.aes = list(size = 4))) +  
  facet_wrap(~year) +
  theme_minimal() +
  theme(
...
```{r}
ggplot(combined_data_va, aes(x = x, y = y, color = spcd, size = cut(dbh, breaks = c(24.5, 43, 66, 81, 178)))) +
  geom_point() +
  scale_color_manual(values = color_palette) +
  labs(title = "VA Stem Map", color = "Species", size = "Diameter (cm)") +
  guides(color = guide_legend(override.aes = list(size = 4))) +  
  facet_wrap(~year) +
  theme_minimal() +
  theme(
