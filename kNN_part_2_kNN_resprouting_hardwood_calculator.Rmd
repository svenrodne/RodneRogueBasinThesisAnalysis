---
title: "knn_part_2_resprouting_hardwoods"
author: "Sven Rodne"
date: "2024-08-08"
...
treebasal <- diamagedtrees %>%
  ...
  filter(conifer == "Hardwood" & multistem == 0) %>%
...
treebasal <- treebasal %>%
  mutate(leftover_rcdm = ((((pi*((rcdm/2)^2)) - (pi*((((diam_cm/0.407348)-5.289323)/2)^2)))/pi)^0.5)*2,
         leftover_dbh = (leftover_rcdm*0.407348) + 5.289323) %>%
...
# knn run on the real full resprouter data
